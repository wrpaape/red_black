#ifndef RED_BLACK_RED_BLACK_TREE_RED_BLACK_UPDATE_SET_H_
#define RED_BLACK_RED_BLACK_TREE_RED_BLACK_UPDATE_SET_H_
...
#endif /* ifndef RED_BLACK_RED_BLACK_TREE_RED_BLACK_UPDATE_SET_H_ */
