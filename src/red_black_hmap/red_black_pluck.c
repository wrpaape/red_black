 ...
 * ────────────────────────────────────────────────────────────────────────── */
typedef void
(*RedBlackPluckHNode)(struct RedBlackHNode *restrict *const restrict tree,
 ...
 * ────────────────────────────────────────────────────────────────────────── */
static void
rb_pluck_l(struct RedBlackHNode *restrict *const restrict tree,
	   struct RedBlackHNode *const restrict parent,
	   const RedBlackComparator comparator,
	   struct RedBlackHNodeFactory *const restrict factory,
	   RedBlackJumpBuffer jump_buffer,
	   ...
	   void **const restrict pluck_ptr);
static void
rb_pluck_r(struct RedBlackHNode *restrict *const restrict tree,
	   struct RedBlackHNode *const restrict parent,
	   const RedBlackComparator comparator,
	   struct RedBlackHNodeFactory *const restrict factory,
	   RedBlackJumpBuffer jump_buffer,
...
void
red_black_pluck(struct RedBlackHNode *restrict *const restrict tree,
		const RedBlackComparator comparator,
		struct RedBlackHNodeFactory *const restrict factory,
		RedBlackJumpBuffer jump_buffer,
		const void *const key,
...
void
red_black_pluck_min(struct RedBlackHNode *restrict *const restrict tree,
		    struct RedBlackHNodeFactory *const restrict factory,
		    RedBlackJumpBuffer jump_buffer,
		    void **const restrict pluck_ptr)
{
...
void
red_black_pluck_max(struct RedBlackHNode *restrict *const restrict tree,
		    struct RedBlackHNodeFactory *const restrict factory,
		    RedBlackJumpBuffer jump_buffer,
		    void **const restrict pluck_ptr)
{
