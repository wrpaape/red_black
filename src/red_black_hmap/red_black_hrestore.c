			  ...
			  struct RedBlackHNode *const restrict rnode)
{
	...
	struct RedBlackHNode *restrict lrrgrandchild;
	struct RedBlackHNode *restrict rrchild; /* rlchild is NULL */
	bool restored;
			 ...
			 struct RedBlackHNode *restrict parent)
{
	...
	struct RedBlackHNode *restrict rlchild;
	struct RedBlackHNode *restrict rrchild;
	struct RedBlackHNode *restrict rllgrandchild;
	struct RedBlackHNode *restrict rlrgrandchild;
			...
			struct RedBlackHNode *const restrict rnode)
{
	struct RedBlackHNode *restrict llchild;
	struct RedBlackHNode *restrict lrchild;
	struct RedBlackHNode *restrict lrlgrandchild;
	struct RedBlackHNode *restrict lrrgrandchild;
		  ...
		  struct RedBlackHNode *restrict rchild)
{
	...
	struct RedBlackHNode *restrict replacement;
	bool restored;

	struct RedBlackHNode *restrict replacement_stack[RED_BLACK_STACK_COUNT];
	struct RedBlackHNode *restrict *restrict replacement_cursor;
