#include "red_black_hmap/red_black_hupdate_set.h" /* types, JUMP API */
 ...
 * ────────────────────────────────────────────────────────────────────────── */
typedef bool
(*RedBlackHUpdateSetHNode)(struct RedBlackHNode *restrict *const restrict tree,
 ...
 * ────────────────────────────────────────────────────────────────────────── */
static bool
rb_hupdate_set_ll(struct RedBlackHNode *restrict *const restrict tree,
		  struct RedBlackHNode *const restrict grandparent,
		  struct RedBlackHNode *const restrict parent,
		  struct RedBlackHNodeFactory *const restrict factory,
		  RedBlackJumpBuffer jump_buffer,
		  ...
		  void **const restrict old_ptr);
static bool
rb_hupdate_set_lr(struct RedBlackHNode *restrict *const restrict tree,
		  struct RedBlackHNode *const restrict grandparent,
		  struct RedBlackHNode *const restrict parent,
		  struct RedBlackHNodeFactory *const restrict factory,
		  RedBlackJumpBuffer jump_buffer,
		  ...
		  void **const restrict old_ptr);
static bool
rb_hupdate_set_rr(struct RedBlackHNode *restrict *const restrict tree,
		  struct RedBlackHNode *const restrict grandparent,
		  struct RedBlackHNode *const restrict parent,
		  struct RedBlackHNodeFactory *const restrict factory,
		  RedBlackJumpBuffer jump_buffer,
		  ...
		  void **const restrict old_ptr);
static bool
rb_hupdate_set_rl(struct RedBlackHNode *restrict *const restrict tree,
		  struct RedBlackHNode *const restrict grandparent,
		  struct RedBlackHNode *const restrict parent,
		  struct RedBlackHNodeFactory *const restrict factory,
		  RedBlackJumpBuffer jump_buffer,
...
int
red_black_hupdate_set(struct RedBlackHNode *restrict *const restrict tree,
		      struct RedBlackHNodeFactory *const restrict factory,
		      RedBlackJumpBuffer jump_buffer,
		      const struct RedBlackHKey *const restrict hkey,
		      void **const restrict old_ptr)
{
	...
	RedBlackHUpdateSetHNode next_hupdate_set;
	int compare;
	int status;
	...
	if (status) {
		if (compare < 0) {
			...
			if (parent == NULL) {
				...
				if (status) {
					next_hupdate_set = (compare < 0)
							 ? &rb_hupdate_set_ll
							 : &rb_hupdate_set_lr;

					(void) next_hupdate_set(tree,
								grandparent,
								parent,
								factory,
								jump_buffer,
	      ...
	      void **const restrict old_ptr)
{
	...
	if (status) {
		...
		status = next_hupdate_set(&grandparent->left,
					  parent,
					  node,
					  factory,
					  jump_buffer,
	      ...
	      void **const restrict old_ptr)
{
	...
	if (status) {
		...
		status = next_hupdate_set(&grandparent->right,
					  parent,
					  node,
					  factory,
					  jump_buffer,
