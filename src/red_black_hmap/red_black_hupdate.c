#include "red_black_hmap/red_black_hupdate.h"  /* types, JUMP API */
 ...
 * ────────────────────────────────────────────────────────────────────────── */
typedef bool
(*RedBlackHUpdateHNode)(struct RedBlackHNode *restrict *const restrict tree,
 ...
 * ────────────────────────────────────────────────────────────────────────── */
static bool
rb_hupdate_ll(struct RedBlackHNode *restrict *const restrict tree,
	      struct RedBlackHNode *const restrict grandparent,
	      struct RedBlackHNode *const restrict parent,
	      struct RedBlackHNodeFactory *const restrict factory,
	      RedBlackJumpBuffer jump_buffer,
	      ...
	      void **const restrict old_ptr);
static bool
rb_hupdate_lr(struct RedBlackHNode *restrict *const restrict tree,
	      struct RedBlackHNode *const restrict grandparent,
	      struct RedBlackHNode *const restrict parent,
	      struct RedBlackHNodeFactory *const restrict factory,
	      RedBlackJumpBuffer jump_buffer,
	      ...
	      void **const restrict old_ptr);
static bool
rb_hupdate_rr(struct RedBlackHNode *restrict *const restrict tree,
	      struct RedBlackHNode *const restrict grandparent,
	      struct RedBlackHNode *const restrict parent,
	      struct RedBlackHNodeFactory *const restrict factory,
	      RedBlackJumpBuffer jump_buffer,
	      ...
	      void **const restrict old_ptr);
static bool
rb_hupdate_rl(struct RedBlackHNode *restrict *const restrict tree,
	      struct RedBlackHNode *const restrict grandparent,
	      struct RedBlackHNode *const restrict parent,
	      struct RedBlackHNodeFactory *const restrict factory,
	      RedBlackJumpBuffer jump_buffer,
...
int
red_black_hupdate(struct RedBlackHNode *restrict *const restrict tree,
		  struct RedBlackHNodeFactory *const restrict factory,
		  RedBlackJumpBuffer jump_buffer,
		  const struct RedBlackHKey *const restrict hkey,
		  void **const restrict old_ptr)
{
	...
	RedBlackHUpdateHNode next_hupdate;
	int compare;
	int status;
	...
	if (status) {
		if (compare < 0) {
			...
			if (parent == NULL) {
				...
				if (status) {
					next_hupdate = (compare < 0)
						     ? &rb_hupdate_ll
						     : &rb_hupdate_lr;

					(void) next_hupdate(tree,
							    grandparent,
							    parent,
							    factory,
							    jump_buffer,
	      ...
	      void **const restrict old_ptr)
{
	...
	if (status) {
		...
		status = next_hupdate(&grandparent->left,
				      parent,
				      node,
				      factory,
				      jump_buffer,
	      ...
	      void **const restrict old_ptr)
{
	...
	if (status) {
		...
		status = next_hupdate(&grandparent->right,
				      parent,
				      node,
				      factory,
				      jump_buffer,
