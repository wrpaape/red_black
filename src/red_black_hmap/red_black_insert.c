 ...
 * ────────────────────────────────────────────────────────────────────────── */
typedef bool
(*RedBlackInsertHNode)(struct RedBlackHNode *restrict *const restrict tree,
 ...
 * ────────────────────────────────────────────────────────────────────────── */
static bool
rb_insert_ll(struct RedBlackHNode *restrict *const restrict tree,
	     struct RedBlackHNode *const restrict grandparent,
	     struct RedBlackHNode *const restrict parent,
	     const RedBlackComparator comparator,
	     struct RedBlackHNodeFactory *const restrict factory,
	     ...
	     const void *const key);
static bool
rb_insert_lr(struct RedBlackHNode *restrict *const restrict tree,
	     struct RedBlackHNode *const restrict grandparent,
	     struct RedBlackHNode *const restrict parent,
	     const RedBlackComparator comparator,
	     struct RedBlackHNodeFactory *const restrict factory,
	     ...
	     const void *const key);
static bool
rb_insert_rr(struct RedBlackHNode *restrict *const restrict tree,
	     struct RedBlackHNode *const restrict grandparent,
	     struct RedBlackHNode *const restrict parent,
	     const RedBlackComparator comparator,
	     struct RedBlackHNodeFactory *const restrict factory,
	     ...
	     const void *const key);
static bool
rb_insert_rl(struct RedBlackHNode *restrict *const restrict tree,
	     struct RedBlackHNode *const restrict grandparent,
	     struct RedBlackHNode *const restrict parent,
	     const RedBlackComparator comparator,
	     struct RedBlackHNodeFactory *const restrict factory,
...
int
red_black_insert(struct RedBlackHNode *restrict *const restrict tree,
		 const RedBlackComparator comparator,
		 struct RedBlackHNodeFactory *const restrict factory,
		 RedBlackJumpBuffer jump_buffer,
		 const void *const key)
{
	...
	RedBlackInsertHNode next_insert;
	int compare;
	int status;
